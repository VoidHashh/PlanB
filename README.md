...
Tienda comunitaria de apps de Umbrel de VoidHashh.

## Cómo añadir esta tienda

En tu Umbrel: **App Store → menú (···) → Community App Stores** y pega:

```
https://github.com/VoidHashh/PlanB
```
